...
import { Delete_user, Update_user } from '../utils/FetchData'
import { logout, login } from '../store/reducers/authSlice'
...
const User = () => {
  ...
  const handleSubmit = async () => {
    try {
      setloading(true)
      const res = await Update_user({ userId: userData._id, ...formData });
      if (res) {
  ...
  return (
    loading ? (
      ...
      <div>
        <span className='font-semibold text-2xl'>My account</span>
        <div className="flex w-max flex-col gap-6 mt-2 mb-4 border border-gray rounded-lg p-8">
          <div className='flex'>
              ...
              {userData.createdAt && (
                <div className='ml-4 flex gap-1'>
                  ...
                  <p className='text-gray-500'>
                    {new Date(userData.createdAt).toLocaleDateString()}  {new Date(userData.createdAt).toLocaleTimeString()}
                  </p>
                </div>
              )}
                ...
                <div className="modal-overlay">
                  <div className="modal">
                    ...
                    <div className="modal-content">
                      ...
                      <p className='font-normal'>Are you sure you want to delete this account?</p>
                      <div className='mt-4 flex gap-2'>
                        <button onClick={() => deleteHandler(userData._id)} className='p-2 bg-blue-600 text-white rounded-lg'>Delete</button>
